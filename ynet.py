...
def main():
    ...
    with open('train_combined_data2.pkl','rb') as f: traindata = pickle.load(f)
    with open('train_combined_labels2.pkl','rb') as f: trainlabels = pickle.load(f)
    
    with open('test_combined_data2.pkl','rb') as f: testdata = pickle.load(f)
    with open('test_combined_labels2.pkl','rb') as f: testlabels = pickle.load(f)
    ...
    with torch.no_grad():
        ...
        with open('ls_acombined1ep2.pkl','wb') as f: pickle.dump(latent_save, f)

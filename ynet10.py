...
def main():
    ...
    with open('train_combined10_data.pkl','rb') as f: traindata = pickle.load(f)
    with open('train_combined10_labels.pkl','rb') as f: trainlabels = pickle.load(f)
    
    with open('test_combined10_data.pkl','rb') as f: testdata = pickle.load(f)
    with open('test_combined10_labels.pkl','rb') as f: testlabels = pickle.load(f)
    ...
    with torch.no_grad():
        ...
        with open('ls_combined1010ep.pkl','wb') as f: pickle.dump(latent_save, f)

...
def main():
    ...
    with open('train_combined100_data.pkl','rb') as f: traindata = pickle.load(f)
    with open('train_combined100_labels.pkl','rb') as f: trainlabels = pickle.load(f)
    
    with open('test_combined100_data.pkl','rb') as f: testdata = pickle.load(f)
    with open('test_combined100_labels.pkl','rb') as f: testlabels = pickle.load(f)
    
    traindata = traindata.reshape(2500000,2,1,28,28)
    testdata = testdata.reshape(500000,2,1,28,28)
    ...
    #Test loop
    latent_save = np.zeros((10,49,100,50000))
    with torch.no_grad():
        test_loss = 0.0
        for i in range(0,10):
            idx = testlabels == i
        ...
        with open('ls_combined100.pkl','wb') as f: pickle.dump(latent_save, f)
